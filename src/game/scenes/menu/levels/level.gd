...
## Square cream level tile. Next = green; exam = purple + cap (same size as regular).
...
func _refresh_chrome() -> void:
	...
	if text_lable:
		...
		# Keep number readable; lock sits in the corner and no longer covers it.
